...
SECRET_KEY = 'django-insecure-#iug)nmapkv-$ic(-b6lp*_qcdk-2wxi#n*jgxxq_8e#*26dt7'
...
INSTALLED_APPS = [
    ...
    'App_seller.apps.AppSellerConfig',
...
if DEBUG:
    ...
    #         'NAME': 'ims_db',  # Replace with your MySQL database name
    ...
    #         'PORT': '3306',  # Replace with your MySQL database port (if using a custom port, otherwise leave empty)
    #     }
    # }
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3',
            'NAME': BASE_DIR / 'db.sqlite3_production',
        }
    }
...
# CORS_ALLOW_ORIGINS = [
#     "",
# ] # This will be enabled when we will build out frontend
...
EMAIL_HOST_PASSWORD = 'iewquqinumikxlir'
